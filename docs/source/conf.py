...
html_help_basename = 'sherlockdoc'
...
texinfo_documents = [
    ('index', 'sherlock', u'sherlock Documentation',
     u'Dave Young', 'sherlock', 'A contextual classifier for astronomical transient sources. Sherlock mines a library of historical and on-going survey data to search for the source of a transient event, and predicting the classification of the event based on that associated data.',
     'Miscellaneous'),
]
